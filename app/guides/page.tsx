...
const characters = [
  ...
  { id: "chizuru", name: "Chizuru", job: "psionic", element: "void", rarity: 5, hasGuide: false },
  ...
  { id: "rei", name: "Rei", job: "controller", element: "void", rarity: 4, hasGuide: false },
  ...
  { id: "sereniel", name: "Sereniel", job: "hunter", element: "instinct", rarity: 5, hasGuide: false },
  { id: "tressa", name: "Tressa", job: "psionic", element: "void", rarity: 4, hasGuide: false },
  { id: "veronica", name: "Veronica", job: "ranger", element: "passion", rarity: 5, hasGuide: false },
        ...
        <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
                    ...
                    >
                      ...
                      <span className="flex items-center gap-1 sm:gap-1.5 font-medium">
                        ...
                        <span className={`
                         ...
                         ${isActive ? (isFiveStar ? "text-purple-300" : "text-orange-300") : "text-foreground"}
                        ...
                        <span
                         ...
                         group-hover:text-white`}
                        >
                          <span className="inline sm:hidden">{isFiveStar ? "★" : "★"}</span>
                          <span className="hidden sm:inline">{isFiveStar ? "★★★★★" : "★★★★"}</span>
                        </span>
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  {elementTypes.map((element) => (
                    <Button
                      ...
                      `}`}>
                      <img src={element.icon || "/placeholder.svg"} alt={element.name} width={32} height={32} className="sm:w-7 sm:h-7 rounded-sm" />
                      <span className="hidden sm:inline text-sm font-medium">{element.name}</span>
                    </Button>
                  ))}
                </div>
              </div>
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-4">
                  {jobTypes.map((job) => (
                    <Button
                      ...
                      className={`
                        gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2  transition-all duration-200 ${selectedJob === job.id
                      ...
                      <img src={job.icon || "/placeholder.svg"} alt={job.name} width={26} height={26} className="sm:w-7 sm:h-7" />
                      <span className="hidden sm:inline text-sm font-medium">{job.name}</span>
                    </Button>
                  ))}
                </div>
              </div>
                    ...
                    <div className="absolute inset-x-0 bottom-0 pointer-events-none">
                      ...
                      ">
                        ...
                        <div className="mt-0.5 sm:mt-1 flex justify-between items-center">
                          <span className={`text-xs sm:text-xs font-bold drop-shadow-2xl ${character.rarity === 5 ? "text-purple-300" : "text-orange-300"}`}>
                            {character.job.charAt(0).toUpperCase() + character.job.slice(1)}
                          </span>
                          <span className={`text-xs sm:text-xs font-bold drop-shadow-2xl ${character.rarity === 5 ? "text-purple-300" : "text-orange-300"}`}>
                            {character.rarity}
                            <span className="ml-0.5 sm:ml-1 align-middle">★</span>
                          </span>
                        </div>
                      </div>
          ...
          {filteredCharacters.length === 0 && (
            <div className="text-center py-12 sm:py-16">
              <p className="text-base sm:text-xl text-muted-foreground mb-4 sm:mb-6">No characters found matching your filters</p>
              <Button
                variant="outline"
                onClick={handleReset}
