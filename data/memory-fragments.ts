...
export const MemoryFragmentSetData: MemoryFragmentSet[] = [
  {
  ...
  },
  {
    ...
    effect:
      "When an Attack Card is used, increased Damage Amount of Order Cards by 10% for 1 turn (2 times per turn)",
  },
  {
    id: "cursed-corpse",
    name: "Cursed Corpse",
    icon: "/images/sets/cursed-corpse.webp",
    effect: "Increase damage dealth to targets inflicted with Agony by 10%",
  },
  {
    ...
    effect:
      "When a card is exhausted, increase Damage Amount of Void Cards by 20% for 1 turn (1 times per turn)",
  },
  {
    id: "black-wing",
    name: "Black Wing",
  ...
  },
  {
    ...
    effect:
      "When there are 4 or more cards in hand, increase Damage Amount of instinct Cards by 20%",
  },
  {
    id: "seths-scarab",
    name: "Seth's Scarab",
  ...
  },
  {
    ...
    effect:
      "When an Upgrade Card is used, increase Damage Amount of the next 5 Passion Cards used by 20%",
  },
  {
